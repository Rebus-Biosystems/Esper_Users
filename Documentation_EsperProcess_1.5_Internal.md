...
The Esper Process software will look for the <sub>'GeneTable.csv'</sub> file in the root folder to fill in the gene names as well as the cycles/lasers associated with each gene. 
